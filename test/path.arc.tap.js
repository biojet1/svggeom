...
import './utils.js';
import {Arc, Cubic, Path} from '../dist/index.js';
...
function dbgwrite(name, pC, pX) {
	function* gen() {
		...
		style =
			'fill:firebrick;stroke:red;stroke-width:2;stroke-dasharray:none;fill-opacity:0.3';

		yield `<path id="calculated" d="${pC}" style="${style}"/>`;
		style =
			'fill:none;stroke:green;stroke-width:1;stroke-dasharray:3,3;fill-opacity:0.3';
