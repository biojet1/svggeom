...
export declare function segment_length(curve: PointAt, start: number, end: number, start_point: Point, end_point: Point, error?: number, min_depth?: number, depth?: number): number;
