...
export declare function cubic_split_at([[sx, sy], [x1, y1], [x2, y2], [ex, ey]]: Iterable<number>[], z: number): Vector[][];
export declare function cubic_slope_at([from, c1, c2, to]: Vector[], t: number): Vector;
export declare function cubic_length(_cpts: Vector[]): number;
