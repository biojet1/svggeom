...
export declare function cubic_box([[sx, sy], [x1, y1], [x2, y2], [ex, ey]]: Iterable<Iterable<number>>): BoundingBox;
export declare function cubic_point_at([[sx, sy], [x1, y1], [x2, y2], [ex, ey]]: Iterable<number>[], t: number): number[];
